        ...
        stage('Building app') {
            steps {
               sh '''
                    ...
                    sudo docker build -t libautomation .
                    sudo docker tag libautomation:latest 211125740082.dkr.ecr.eu-north-1.amazonaws.com/libautomation:$BUILD_NUMBER
                    sudo docker push 211125740082.dkr.ecr.eu-north-1.amazonaws.com/libautomation:$BUILD_NUMBER 

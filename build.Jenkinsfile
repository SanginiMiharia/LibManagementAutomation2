        ...
        stage('Building app') {
            steps {
               sh '''
                    ...
                    sudo -S docker build -t libautomation .
                    sudo -S docker tag libautomation:latest 211125740082.dkr.ecr.eu-north-1.amazonaws.com/libautomation:$BUILD_NUMBER
                    sudo -S docker push 211125740082.dkr.ecr.eu-north-1.amazonaws.com/libautomation:$BUILD_NUMBER 
